...
+ (NSError *)deflateErrorWithCode:(NSInteger)code;
@end
...
+ (NSError *)deflateErrorWithCode:(NSInteger)code
{
	return [NSError errorWithDomain:NetworkRequestErrorDomain code:ASICompressionError userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"Compression of data failed with code %li",(long)code],NSLocalizedDescriptionKey,nil]];
}
